...
--// Functions
function LevelProgression.AdjustXp(player , amount) --adding Xp to the player 
    ...
    --Leveling loop 
    while totalXp >= LevelSystemConfig.GetXpForLevel(player , currentLevel) do
        totalXp -= LevelSystemConfig.GetXpForLevel(player , currentLevel)
...
--// receving Signals
Signals.XPChanged:Connect(function(player, amount)
